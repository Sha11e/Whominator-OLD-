...
public class vlc
{
  public static void PauseAndPlay()
    throws Exception
  {
    Socket sock = new Socket("127.0.0.1", Integer.parseInt(client.pref.get("VLC_PORT", "")));
  ...
  public static void testVLC()
  {
    ...
    try
    {
      sock = new Socket("127.0.0.1", Integer.parseInt(client.pref.get("VLC_PORT", "")));
    ...
    catch (Exception ex)
    {
      ...
      {
        System.out.println("------------------");
        System.out.println("Could not make a connection to VLC on port " + client.pref.get("VLC_PORT", ""));
        ...
        System.out.println("7. In TCP command input, type '127.0.0.1:" + client.pref.get("VLC_PORT", "") + "'");
